...
#[Route('templatefrontoffice/reclamation')]
class FrontReclamationController extends AbstractController
{
    ...
    public function index(Request $request, ReclamationRepository $reclamationRepository, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('templatefrontoffice/reclamation/index.html.twig', [
    ...
    public function edit(Request $request, int $id, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('templatefrontoffice/reclamation/edit.html.twig', [
    ...
    public function generatePdfAction($reclamationId, EntityManagerInterface $entityManager)
    {
        ...
        $userName = $reclamation->getUser() ? $reclamation->getUser()->getEmail() : 'Inconnu';
        ...
        $html = $this->renderView('templatefrontoffice/reclamation/rapport.html.twig', [
            'reclamation' => $reclamation,
