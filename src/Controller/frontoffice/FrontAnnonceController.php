...
#[Route('templatefrontoffice/annonce')]
final class FrontAnnonceController extends AbstractController
{
    ...
    {
        return $this->render('templatefrontoffice/annonce/show.html.twig', [
            'annonce' => $annonce,
        ]);
    }
