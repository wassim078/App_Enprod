...
class FrontCollectController extends AbstractController
{ 
    ...
    #[Route('/', name: 'collect_list')]
    public function list(CollectRepository $collectsRepo): Response
    {
    ...
    {
        return $this->render('templatefrontoffice/collect/show.html.twig', [
            'collect' => $collect,
        ]);
    }
