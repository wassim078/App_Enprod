...
{
    #[Route('templatefrontoffice/reponse', name: 'app_reponse')]
    ...
    {   $reclamation = new Reclamation();
        ...
        return $this->render('templatefrontoffice/reponse/index.html.twig', [
   ...
   #[Route('templatefrontoffice/reponse/new/{reclamationId}', name: 'newRep', methods: ['GET', 'POST'])]
    public function new(Request $request, $reclamationId, MailerInterface $mailer,ManagerRegistry $doctrine): Response
    {
        ...
        return $this->render('templatefrontoffice/reponse/formRep.html.twig', [
        ...
        #[Route("templatefrontoffice/reponse/{reclamationId}", name:"reponse_show")]
        public function show(int $reclamationId, ReclamationRepository $reclamationRepository,ManagerRegistry $doctrine): Response
        {
            ...
            return $this->render('templatefrontoffice/reponse/ShowReponse.html.twig', [
        ...
        #[Route('templatefrontoffice/delete/response/{id}', name: 'app_response_delete', methods: ['GET'])]
